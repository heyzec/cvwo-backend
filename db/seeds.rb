...
dental_list.tasks.create(text: "Get referral from polyclinic", day: "2021-12-06T16:12:00.000Z")
dental_list.tasks.create(text: "Visit specialist", day: "2021-12-06T16:12:00.000Z")

project_list = tester.lists.create(text: "Coding Project")
project_list.tasks.create(text: "First team meeting", day: "2021-12-06T16:12:00.000Z")
project_list.tasks.create(text: "Execution plan submission", day: "2021-12-06T16:12:00.000Z")
project_list.tasks.create(text: "Second team meeting", day: "2021-12-06T16:12:00.000Z")
project_list.tasks.create(text: "Final submission", day: "2021-12-06T16:12:00.000Z")


tester2 = User.create(email: "heyzec-cvwo-tester2", password_digest: "$2a$12$1wo7nIfm5Lz1Am7BCDAKUeQoSekxb5ZzWV61n/L4LkrtXSySRW0uy")
